                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="datetime-local" id="res_date" name="res_date"
                                    value='{{Carbon::parse($reservation->res_date)->format('Y-m-d\TH:i:s')}}'
                                    class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                            @error('res_date')
                            <div class="text-sm text-red-400">{{$message}}</div>
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <select name="table_id" id="table_id" class="block w-full mt-1">
                                    ...
                                    <option value="{{$table->id}}" @selected($table->id==$reservation->
                                        table_id)>{{$table->name}} ({{$table->guest_number}}) Guest
                                    </option>
                                    @endforeach
                                </select>
                            </div>
